...
class BasePlayer(BaseModel, ABC):
    ...
    last_target: Optional["BasePlayer"] = None
    ...
    @abstractmethod
    def choose_action(
        self, other_players: List["BasePlayer"], revealed_cards:List[Card], deck_len:int, treasury:int
    ...
    @abstractmethod
    def determine_counter(self, player: "BasePlayer",game) -> CounterAction:
        """Choose whether to counter the current player's action"""
        pass

    @abstractmethod
    def remove_card(self, game) -> None:
